...
Proton- or generally ion dynamics in fluids directly imply fluctuations in the potential and conductivity of objects which are surrounded by the fluid. The major processes which influence the motion which are considered here are \effect{absorption} and \effect{desorption} processes. The more ions are absorbed on a surface the more they influence its potential. The more ions are left in the fluid the higher is its conductivity which dues to ionic currents at all.

In this document the motion of one particle is considered as a brownian motion. 
