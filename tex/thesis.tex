...
\begin{align}
\langle x_n^2\rangle = \int_{-\infty}^\infty x^2 \cdot \rho(x,t)\; dx = 2 D t \myEqLabel{MSD}
\end{align}
...
\myImage{position}{Position of an ion}

\section{Comparision to the analytical Calculation}
