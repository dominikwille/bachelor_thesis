...
num_a = float(data[5][0])
num_d = float(data[6][0])
xdata = numpy.array(map(float, data[0]))
c_aa = numpy.array(map(float, data[1])) / num_a
c_ab = numpy.array(map(float, data[2])) / num_a
c_ad = numpy.array(map(float, data[3])) / num_a
c_dd = numpy.array(map(float, data[4])) / num_d
